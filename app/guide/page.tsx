...
const guideFaqItems = [
  ...
  },
  {
    ...
    answer:
      "현재 MVP에서는 악보 이미지와 송폼을 바탕으로 코드 진행, 메트로놈, 카운트인, 음성 안내 설정이 담긴 가이드 트랙 데이터를 만들고 브라우저에서 미리듣는 기능을 제공합니다. 완성 오디오 파일 생성은 이후 팀 녹음실 기능에서 확장할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer: "네. 1마디 또는 2마디 카운트인을 설정할 수 있고, 카운트인 클릭과 음성 카운트를 따로 켜고 끌 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "네. 생성된 가이드 트랙은 WAV 파일로 다운로드할 수 있습니다. 다만 브라우저 환경에 따라 음성 안내는 다운로드 파일에 포함되지 않을 수 있고, 이 경우 가이드 트랙 데이터 JSON을 내려받을 수 있습니다.",
  },
  {
      ...
      <GuideSection id="lab" index={14} title="실험실과 팀 가이드 트랙">
        ...
        <StepList
          items={[
            ...
            ["카운트인", "곡 시작 전 1마디 또는 2마디 카운트인을 설정하고, 클릭음과 음성 카운트를 각각 켜거나 끌 수 있습니다."],
            ["송폼 음성 안내", "Intro, Verse, Chorus 같은 구간명이 시작 직전에 들리도록 음성 안내를 켤 수 있습니다."],
            ["데이터 저장", "가이드 트랙 데이터를 저장하고, 브라우저에서 카운트인과 메트로놈, 음성 안내를 포함해 미리 들을 수 있습니다."],
            ["다운로드", "가이드 트랙을 WAV로 내려받을 수 있습니다. 브라우저 음성 안내는 다운로드 파일에 포함되지 않을 수 있어 JSON 다운로드 fallback도 제공합니다."],
          ]}
        />
        <Callout tone="warning">
