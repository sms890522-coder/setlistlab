...
const guideFaqItems = [
  ...
  },
  {
    ...
    answer: "네. 첫 버전은 마이크 입력을 지원합니다. 녹음 중에는 화면을 끄거나 다른 앱으로 이동하지 않는 것을 권장합니다.",
  },
  {
    question: "라인 입력이나 오디오 인터페이스도 사용할 수 있나요?",
    answer:
      "추후 지원을 고려하고 있습니다. 브라우저에서 입력 장치로 인식되는 경우 선택할 수 있도록 구조를 준비하고 있습니다.",
  },
  {
    ...
    <div className="page-shell space-y-8 pb-20">
      ...
      <GuideSection id="lab" index={14} title="실험실과 팀 가이드 트랙/팀 녹음실">
        ...
        <div className="rounded-2xl border border-violet-100 bg-violet-50/70 p-4">
          ...
          <p className="mt-2">
            팀 녹음실은 가이드 트랙을 들으면서 팀원들이 각자 자신의 파트를 녹음할 수 있는 실험실 기능입니다.
            처음에는 마이크 입력을 지원하며, 추후 라인 입력과 오디오 인터페이스 입력도 지원할 수 있도록 준비 중입니다.
          </p>
          <StepList
            items={[
              ["진입", "저장된 가이드 트랙 화면에서 팀 녹음실 열기 버튼으로 이동합니다."],
              ["가이드 확인", "가이드 트랙의 BPM, Key, 카운트인, 메트로놈을 확인하고 재생해봅니다."],
              ["마이크 권한", "마이크 권한을 허용하고 입력 장치를 선택합니다. 권한 허용 전에는 장치 이름이 비어 있을 수 있습니다."],
              ["파트 녹음", "보컬, 일렉, 건반, 드럼 등 내 파트를 선택하고 녹음 시작/중지 버튼으로 녹음합니다."],
              ["미리듣기", "저장 전 내 녹음을 다시 들어보고 필요하면 다시 녹음합니다."],
              ["저장", "녹음 파일은 별도 오디오 저장소에 업로드되고, Supabase에는 권한과 메타데이터만 저장됩니다."],
              ["팀 목록", "같은 팀의 승인된 팀원은 녹음 목록을 확인하고 재생할 수 있습니다."],
            ]}
          />
        </div>
        <Callout tone="warning">
