...
const guideFaqItems = [
  ...
  },
  {
    ...
    answer:
      "네. 생성된 가이드 트랙은 WAV 파일로 다운로드할 수 있습니다. 화면 카운터는 재생 화면에서만 표시되고 다운로드 파일에는 포함되지 않으며, WAV 렌더링이 어려우면 가이드 트랙 데이터 JSON을 내려받을 수 있습니다.",
  },
  {
      ...
      <GuideSection id="lab" index={14} title="실험실과 팀 가이드 트랙">
        ...
        <StepList
          items={[
            ...
            ["다운로드", "가이드 트랙을 WAV로 내려받을 수 있습니다. 화면 카운터는 재생 UI 기능이라 다운로드 파일에는 포함되지 않으며 JSON 다운로드 fallback도 제공합니다."],
          ]}
        />
        <Callout tone="warning">
