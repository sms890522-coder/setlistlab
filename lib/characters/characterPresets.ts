...
export const CHARACTER_PRESET_VARIANTS = [
  ...
  { value: "soft", label: "프리셋 A", description: "다른 헤어와 의상, 역할 아이템" },
  { value: "warm", label: "프리셋 B", description: "다른 실루엣과 역할 아이템" },
  { value: "vivid", label: "프리셋 C", description: "다른 무대 스타일과 역할 아이템" },
