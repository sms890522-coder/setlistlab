  ...
  return (
    <section className="card p-5 sm:p-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <span className="rounded-full bg-blue-50 px-3 py-1 text-xs font-black text-blue-700">{scopeLabel}</span>
      </div>
      ...
      <div className="mt-5 space-y-3">
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-5 text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">콘티에 대한 확인 메시지나 질문을 남겨보세요.</p>
          </div>
        ) : (
      ...
      {canComment ? (
        <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <label className="field-label" htmlFor={`setlist-comment-content-${setlistId}`}>댓글 작성</label>
          <textarea
